...
import cz.dbydzovsky.multiAnsibleRunner.clusterProvider.ClusterEnvironment
...
class LocalSystemClusterProvider: ClusterProvider {

    override fun provide(clusterEnvironment: ClusterEnvironment): List<NodeInfo> {
